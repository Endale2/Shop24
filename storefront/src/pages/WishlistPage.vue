  ...
  <div class="wishlist-container">
    <div class="max-w-6xl mx-auto">
      ...
      <div v-if="!authStore.user" class="text-center py-12">
        ...
        <div class="space-x-4">
          <button @click="goToLogin" class="inline-block bg-black text-white py-3 px-6 rounded-none font-semibold uppercase tracking-wide hover:bg-gray-800 transition-colors">
            Sign In
          </button>
          <button @click="goToRegister" class="inline-block bg-white text-black border border-black py-3 px-6 rounded-none font-semibold uppercase tracking-wide hover:bg-gray-50 transition-colors">
            Create Account
          </button>
        </div>
      </div>
      ...
      <div v-else>
        ...
        <div v-else class="text-center py-12">
          ...
          <button @click="goToProducts" class="inline-block bg-black text-white py-3 px-6 rounded-none font-semibold uppercase tracking-wide hover:bg-gray-800 transition-colors">
            Browse Products
          </button>
        </div>
      </div>
